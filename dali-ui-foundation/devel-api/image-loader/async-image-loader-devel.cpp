...
{
uint32_t LoadAnimatedImage(AsyncImageLoader asyncImageLoader, Dali::AnimatedImageLoading animatedImageLoading,
                           uint32_t frameIndex, DevelAsyncImageLoader::PreMultiplyOnLoad preMultiplyOnLoad)
{
              ...
              DevelAsyncImageLoader::PreMultiplyOnLoad preMultiplyOnLoad)
{
  return GetImplementation(asyncImageLoader)
    .Load(Ui::Internal::VisualUrl(url), dimensions, samplingMode, orientationCorrection,
