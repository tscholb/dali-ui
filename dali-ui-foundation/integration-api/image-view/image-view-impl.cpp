...
IMAGE_VIEW_PROPERTY_REGISTRATION("desiredWidth",         FLOAT,   DESIRED_WIDTH)
IMAGE_VIEW_PROPERTY_REGISTRATION("desiredHeight",        FLOAT,   DESIRED_HEIGHT)
  ...
  if(view)
  {
    ...
    switch(index)
    {
      ...
      case Property::DESIRED_WIDTH:
      {
        ...
        if(value.Get(width))
        {
          impl.SetDesiredWidth(static_cast<int>(width));
        }
        break;
      }
      case Property::DESIRED_HEIGHT:
      {
        ...
        if(value.Get(height))
        {
          impl.SetDesiredHeight(static_cast<int>(height));
        }
        break;
      }
  ...
  if(view)
  {
    ...
    switch(index)
    {
      ...
      case Property::SAMPLING_MODE:
        ...
        break;
      case Property::DESIRED_WIDTH:
        value = static_cast<float>(impl.GetDesiredWidth());
        break;
      case Property::DESIRED_HEIGHT:
        value = static_cast<float>(impl.GetDesiredHeight());
        break;
      case Property::IMAGE_COLOR:
