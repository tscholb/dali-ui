#ifndef DALI_UI_TEXTURE_ASYNC_LOADING_HELPER_H
#define DALI_UI_TEXTURE_ASYNC_LOADING_HELPER_H
...
private:
  /**
   * @brief Callback to be called when texture loading is complete, it passes the pixel buffer list on to texture
   * manager.
...
#endif // DALI_UI_TEXTURE_ASYNC_LOADING_HELPER_H
