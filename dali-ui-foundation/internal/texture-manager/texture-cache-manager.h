#ifndef DALI_UI_TEXTURE_CACHE_MANAGER_H
#define DALI_UI_TEXTURE_CACHE_MANAGER_H
...
public:
   ...
   * @param[in] textureCacheIndex the index of the cache container. If we don't setup this value, default is
   * INVALID_CACHE_INDEX
   * @return A TextureId
   */
...
private:
   ...
   * @return                       A TextureCacheIndex of a cached Texture if found. Or INVALID_CACHE_INDEX if not
   * found.
   */
