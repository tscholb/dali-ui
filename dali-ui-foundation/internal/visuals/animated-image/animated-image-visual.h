 ...
 *
 * wrapModeU and wrapModeV separately decide how the texture should be sampled when the u and v coordinate exceeds the
 * range of 0.0 to 1.0. Its value should be one of the following wrap mode: "DEFAULT" "CLAMP_TO_EDGE" "REPEAT"
 *   "MIRRORED_REPEAT"
 *
...
class AnimatedImageVisual : public Visual::Base, public ConnectionTracker, public ImageCache::FrameReadyObserver
{
public:
  /**
   ...
   */
  static AnimatedImageVisualPtr New(VisualFactoryCache& factoryCache, ImageVisualShaderFactory& shaderFactory,
