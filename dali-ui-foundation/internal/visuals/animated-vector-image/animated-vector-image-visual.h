#ifndef DALI_UI_INTERNAL_ANIMATED_VECTOR_IMAGE_VISUAL_H
#define DALI_UI_INTERNAL_ANIMATED_VECTOR_IMAGE_VISUAL_H
...
#endif // DALI_UI_INTERNAL_ANIMATED_VECTOR_IMAGE_VISUAL_H
