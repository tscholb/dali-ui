...
struct AnimatedImageViewPropertyIndex
{
  ...
  enum
  {
     ...
     * @note See also: AnimatedImageView::SetSynchronousLoading(), AnimatedImageView::GetSynchronousLoading().
     */
    SYNCHRONOUS_LOADING,
     ...
     * @note See also: AnimatedImageView::SetPreMultipliedAlpha(), AnimatedImageView::GetPreMultipliedAlpha().
     */
    PRE_MULTIPLIED_ALPHA,

    ///////////////////////////////////////////////////////////////////////////////
    // Size & Fitting (Phase 2)
    ///////////////////////////////////////////////////////////////////////////////
     ...
     * @note See also: AnimatedImageView::SetImageLoadWithViewSize(), AnimatedImageView::GetImageLoadWithViewSize().
     */
    IMAGE_LOAD_WITH_VIEW_SIZE,

    ///////////////////////////////////////////////////////////////////////////////
    // Masking & Placeholder (Phase 3)
    ///////////////////////////////////////////////////////////////////////////////
     ...
     * @note See also: AnimatedImageView::SetCropToMask(), AnimatedImageView::GetCropToMask().
     */
    CROP_TO_MASK,
     ...
     * @note Setting this overrides IMAGE. See also: AnimatedImageView::SetImageUrls().
     */
    IMAGE_URLS,
