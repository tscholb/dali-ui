...
struct ImageViewPropertyIndex
{
  ...
  enum
  {
     ...
     * @note See also: ImageView::SetDesiredSize(), ImageView::GetDesiredSize().
     */
    DESIRED_WIDTH,
     ...
     * @note See also: ImageView::SetPreMultipliedAlpha(), ImageView::GetPreMultipliedAlpha().
     */
     ...
     * @note See also: ImageView::SetImageLoadWithViewSize(), ImageView::GetImageLoadWithViewSize().
     */
     ...
     * @note See also: ImageView::SetCropToMask(), ImageView::GetCropToMask().
     */
    CROP_TO_MASK,
     ...
     * @note See also: ImageView::SetSynchronousLoading(), ImageView::GetSynchronousLoading().
     */
    SYNCHRONOUS_LOADING,
     ...
     * @note See also: ImageView::SetFastTrackUploading(), ImageView::GetFastTrackUploading().
     */
     ...
     * @note See also: ImageView::SetOrientationCorrection(), ImageView::GetOrientationCorrection().
     */
     ...
     * @note See also: ImageView::SetNPatchBorderOnly(), ImageView::GetNPatchBorderOnly().
     */
    N_PATCH_BORDER_ONLY,
