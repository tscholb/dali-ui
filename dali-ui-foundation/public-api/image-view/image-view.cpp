...
ImageView& ImageView::SetPreMultipliedAlpha(bool preMultipled)
{
  Ui::GetImpl(*this).SetPreMultipliedAlpha(preMultipled);
  return *this;
}
...
ImageView& ImageView::SetImageColor(const Vector4& color)
{
  Ui::GetImpl(*this).SetImageColor(color);
  return *this;
}

Vector4 ImageView::GetImageColor() const
{
