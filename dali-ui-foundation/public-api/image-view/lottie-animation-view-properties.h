...
struct LottieAnimationViewPropertyIndex
{
  ...
  enum
  {
     ...
     * @note See also: LottieAnimationView::SetSynchronousLoading(), LottieAnimationView::GetSynchronousLoading().
     */
    SYNCHRONOUS_LOADING,
     ...
     * @note See also: LottieAnimationView::SetPreMultipliedAlpha(), LottieAnimationView::GetPreMultipliedAlpha().
     */
