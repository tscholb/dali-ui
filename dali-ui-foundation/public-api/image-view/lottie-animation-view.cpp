...
LottieAnimationView& LottieAnimationView::SetMinMaxFrameByMarker(const Dali::String& marker1, const Dali::String& marker2)
{
  Ui::GetImpl(*this).SetMinMaxFrameByMarker(marker1, marker2);
  return *this;
}
...
LottieAnimationView& LottieAnimationView::Flush()
{
  Ui::GetImpl(*this).Flush();
  return *this;
}
