 ...
 *   3. URL Array: dog-anim-001~008.png     (8 PNG frames via SetImageUrls)
 *   4. URL Array: dali-logo-anim-001~015.png  (15 PNG frames via SetImageUrls)
 *
...
private:
  ...
  void ApplyCurrentImage()
  {
    ...
    if(mImageIndex >= 3)
    {
      ...
      mAnimatedImageView.SetImageUrls(urls);
    }
    else
    {
      // Single animated file
      mAnimatedImageView.SetImageUrls(Dali::Vector<Dali::String>{});
