...
private:
  ...
  View CreateModeButton(int index)
  {
    ...
    button.GetOrAttachClickableTrait().ClickedSignal().Connect(this, &ImageViewFittingModeController::OnModeButtonClicked);
  ...
  View CreateSwapButton()
  {
    ...
    button.GetOrAttachClickableTrait().ClickedSignal().Connect(this, &ImageViewFittingModeController::OnSwapButtonClicked);

    mSwapButton = button;
    return button;
  }

  bool OnModeButtonClicked(View clickedView, const InputEvent& /*event*/)
  {
    for(int i = 0; i < MODE_COUNT; ++i)
    {
  ...
  bool OnSwapButtonClicked(View /*clickedView*/, const InputEvent& /*event*/)
  {
