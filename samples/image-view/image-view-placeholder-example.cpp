...
private:
  void OnInit(Application& application)
  {
    ...
    mButton.GetOrAttachClickableTrait().ClickedSignal().Connect(this, &PlaceholderSampleController::OnButtonClicked);
  ...
  bool OnButtonClicked(View /*clickedView*/, const InputEvent& /*event*/)
  {
    LoadNextImage();
    return true;
  }
